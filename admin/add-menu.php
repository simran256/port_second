            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <form action="" method="post" class="form-control mt-3 pt-4 ps-3 pe-3" enctype="multipart/form-data">
                        <!-- Product Name Field -->
                        <input type="text" placeholder="Menu Name" name="name" class="form-control mt-3" oninput="generateSlug()">

                        <!-- Generated Product URL Field -->
                        <input type="text" placeholder="Menu-URL" name="pd_url" class="form-control mt-3" readonly>
